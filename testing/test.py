### CS 441, Fall 2022 - Group Project: Battleships - Debug & Testing File
### Primary Objectives: Debugging & Testing classes & functions.
...
def main():
    testboard = Board()
    testboard.create_ships()
    
    testboard.print_board()
    testboard.print_board(False)
